...
JAZZMIN_SETTINGS = {
    "site_title": "Umar website",  # Заголовок админ-панели
    "site_header": "Umar website",  # Заголовок на экране входа
    "site_brand": "Umar website",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в Umar website",  # Приветственное сообщение
    "site_title": "Umar website",  # Заголовок админ-панели
    "site_header": "Umar website",  # Заголовок на экране входа
    "site_brand": "Umar website",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в Umar website",  # Приветственное сообщение
